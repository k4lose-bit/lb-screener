...
.theme-stock-row{background:var(--bg-card);border-radius:10px;padding:12px 16px;margin-bottom:8px;box-shadow:0 2px 6px var(--shadow);display:flex;align-items:flex-start;gap:12px;flex-wrap:wrap}
